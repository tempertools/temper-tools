-- temper_wav_io.lua -- RIFF/WAV chunk reader and cue chunk writer for Temper Mark
...
--
-- Usage:
--   local wav_io = dofile(reaper.GetResourcePath() .. "/Scripts/Temper/lib/temper_wav_io.lua")
