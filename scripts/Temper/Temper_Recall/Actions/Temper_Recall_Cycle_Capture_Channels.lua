...
-- @description Temper: Recall – Cycle Capture Channels
-- @author Temper Tools
-- @noindex
...
if actions.gui_is_running("TEMPER_Recall") then
  actions.dispatch("TEMPER_Recall", "cycle_capture_channels")
else
  actions.notify_gui_required("Recall")
end
