-- rsg_import.lua — File import helpers, WAV cue reading, item trim utilities
...
--
-- Usage:
--   local import_mod = (dofile(reaper.GetResourcePath() .. "/Scripts/ABS/lib/rsg_import.lua"))(CONFIG)
--
