-- temper_alloy_merge.lua -- Variant grouping and merge planning for Temper Alloy
...
--
-- Usage:
--   local merge = dofile(reaper.GetResourcePath() .. "/Scripts/Temper/lib/temper_alloy_merge.lua")
...
-- @param wav_io table The temper_wav_io module
