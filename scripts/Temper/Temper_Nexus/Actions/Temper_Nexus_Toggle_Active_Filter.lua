...
-- @description Temper: Nexus – Toggle Active-Only Filter
-- @author Temper Tools
-- @noindex
...
if actions.gui_is_running("TEMPER_Nexus") then
  actions.dispatch("TEMPER_Nexus", "toggle_active_filter")
else
  actions.notify_gui_required("Nexus")
end
